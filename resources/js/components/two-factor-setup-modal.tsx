    ...
    const modalConfig = useMemo<{
        ...
        if (twoFactorEnabled) {
            return {
                ...
                description:
                    'El 2FA ya está activo. Escanea el código QR o introduce la clave en tu app de autenticación.',
                buttonText: 'Cerrar',
            };
        }
        ...
        return {
            ...
            description:
                'Para terminar, escanea el código QR o introduce la clave de configuración en tu app de autenticación',
            buttonText: 'Continuar',
        };
