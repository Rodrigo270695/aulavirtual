            ...
            <Dialog open={searchOpen} onOpenChange={setSearchOpen}>
                <DialogContent className="max-w-xl overflow-hidden p-0">
                    <DialogHeader className="px-4 pt-4">
                        ...
                        <DialogDescription>
                            Navega por secciones del panel. Atajo: Ctrl/Cmd + K.
                        </DialogDescription>
                    </DialogHeader>
                    <Command className="rounded-none border-t border-slate-100">
                        ...
                        <CommandList>
                            ...
                            <CommandGroup heading="Comercio y sistema">
                                {quickSearchItems
                                    .filter((item) => item.group !== 'Principal' && item.group !== 'Administración')
                                    .map((item) => (
                                        <CommandItem
                                            key={item.href}
                                            value={`${item.label} ${item.hint}`}
